...
const getEmoji = (key: string) => {
  for (let i = 0; i < fruits_data.length; i++) {
    if (fruits_data[i].id === key) return fruits_data[i].emoji;
  }
};
...
const AmexIcon = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill="#016fd0">
...
const DinersClubIcon = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill="#0079be">
...
const DiscoverIcon = () => {
  return (
    <>
      <svg viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg" fill="#ec6b29">
...
const VisaIcon = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill="#1434cb">
